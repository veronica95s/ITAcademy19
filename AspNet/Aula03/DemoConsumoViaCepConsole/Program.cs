try
{
    ...
    var resultado = await ViaCepConsumidor.ConsultarV1("90010350");
    ...
    var resultadoV2 = await ViaCepConsumidor.ConsultarV2("90020004");
    Console.WriteLine(resultadoV2);

    Console.WriteLine("ConsultarV3:");
    var resultadoV3 = await ViaCepConsumidor.ConsultarV3("92990000");
    if (resultadoV3 != null) {
